...
SCHEMAS = [
    {
        "name": "listar_correos",
        "description": "Lista correos del buzón de Selva Negra, opcionalmente filtrando con sintaxis Gmail.",
        "input_schema": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Filtro estilo Gmail. Ej.: 'from:cliente@dominio.com', 'is:unread', 'subject:pedido'.",
                },
                "max_resultados": {
                    "type": "integer",
                    "minimum": 1,
    ...
    {
        "name": "enviar_correo",
        "description": "Envía un correo desde la cuenta de Selva Negra. Confirmá el contenido con el usuario antes de llamar.",
        "input_schema": {
            "type": "object",
            "properties": {

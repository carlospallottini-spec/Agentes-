...
_ITEMS_SCHEMA = {
    ...
    "items": {
        "type": "object",
        "properties": {
            "id": {"type": "string", "description": "ID del producto del menú (ej. 'SN01')."},
...
SCHEMAS = [
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "items": _ITEMS_SCHEMA,
                "notas": {"type": "string", "description": "Comentarios o pedidos especiales."},
            },
    ...
    {
        "name": "agendar_pedido",
        "description": "Agenda un pedido para una fecha y hora específicas. Recordá que las tortas Selva Negra y Sachertorte requieren al menos 48 hs de anticipación.",
        "input_schema": {
            "type": "object",
            "properties": {
                "cliente": {"type": "string"},
                ...
                "hora_entrega": {"type": "string", "description": "Formato HH:MM (24 hs)."},
                "notas": {"type": "string"},
            },
